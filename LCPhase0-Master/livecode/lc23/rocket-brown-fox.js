...
function countLetterRecursive(sentence, letter) {
	...
	return count + countLetterRecursive(str, letter)
...
// hitung length recrusively, APPARENTLY IT WAS AN ACCIDENTS THAT I FOUND THIS LOLOLOL
	// if(sentence.length === 0){
	// 	return 1;
	// } else {
	// 	var modif = sentence.substring(1);
	// 	return 1 + countLetterRecursive(modif, letter)
